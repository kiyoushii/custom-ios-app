...
const DEFAULT_SPLITS: WorkoutSplit[] = [
  {
    id: '1',
    name: 'Спина + Бицепс',
    exercises: ['Тяга верхнего блока', 'Тяга штанги в наклоне', 'Подтягивания', 'Подъем штанги на бицепс', 'Молотковые сгибания'],
  },
  {
    id: '2',
    name: 'Грудь + Трицепс',
    exercises: ['Жим лежа', 'Жим гантелей под углом', 'Разводка гантелей', 'Брусья', 'Разгибания на трицепс в блоке'],
  },
  {
    id: '3',
    name: 'Ноги + Плечи',
    exercises: ['Приседания со штангой', 'Жим ногами', 'Выпады', 'Армейский жим', 'Махи гантелями в стороны'],
  },
];
